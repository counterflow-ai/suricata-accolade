...
const char * SCErrorToString(SCError err)
{
    switch (err) {
        ...
        CASE_CODE (SC_ERR_ACCOLADE_OPEN_FAILED);
        CASE_CODE (SC_ERR_ACCOLADE_NOSUPPORT);
        CASE_CODE (SC_ERR_ACCOLADE_REQUIRED);
        CASE_CODE (SC_ERR_ACCOLADE_INIT_FAILED);
        CASE_CODE (SC_ERR_ACCOLADE_PARSE_CONFIG);
